...
| disabledByMicrosoftStatus |  Enum |Specifies if the registered service principal object has been disabled by Microsoft and the reason why. These reasons may include suspicious/abusive activity, malicious activity, and/or a violation of the Microsoft Services Agreement. Possible values are: <ul> <li> 0 - notDisabled</li><li> 1 - disabledDueToViolationOfServicesAgreement </li></ul>|
